...
100.times do |post|
  Post.create!(date: Date.today, work_performed: "#{post} work_performed content lorem ipsum some other yadayada content stuff and face", status: 0, user_id: @employee.id, daily_hours: 2.5 )
end
